...
<head>
    ...
    <title>AOT_Track – Season 3 OST</title>
    <link rel="stylesheet" href="../CSS/Playlist_Season3.css" />
    <script src="../JS/Playlist_Functions.js" defer></script>
</head>

<body data-album-color="hsl(192, 100%, 60%)">
    ...
    <div class="album-layout">
        ...
        <div class="album-cover-section">
            <img src="../Images/Cover3.jpg" class="album-cover">
            <br>
        ...
        <div class="album-info">
            ...
            <h1 class="album-title">"Attack on Titan" Season 3</h1>
