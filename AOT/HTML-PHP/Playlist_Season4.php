...
<head>
    ...
    <title>AOT_Track – Season 4 OST</title>
    <link rel="stylesheet" href="../CSS/Playlist_Season4.css" />
    <script src="../JS/Playlist_Functions.js" defer></script>
</head>

<body data-album-color="hsl(6, 100%, 60%)">
    ...
    <div class="album-layout">
        ...
        <div class="album-cover-section">
            <img src="../Images/Cover4.jpg" class="album-cover">
            <br>
        ...
        <div class="album-info">
            ...
            <h1 class="album-title">"Attack on Titan" Season 4</h1>
            <h3 class="album-writer"><span class="white_M">Music by</span>
                KOHTA YAMAMOTO <span class="white_M">/</span> HIROYUKI SAWANO
            </h3>
