...
<head>
    ...
    <title>AOT_Track – Season 2 OST</title>
    <link rel="stylesheet" href="../CSS/Playlist_Season2.css" />
    <script src="../JS/Playlist_Functions.js" defer></script>
</head>

<body data-album-color="hsl(337, 100%, 60%)">
    ...
    <div class="album-layout">
        ...
        <div class="album-cover-section">
            <img src="../Images/Cover2.jpg" class="album-cover">
            <br>
        ...
        <div class="album-info">
            ...
            <h1 class="album-title">"Attack on Titan" Season 2</h1>
